...
function saveNavigation(){
 ...
 storage.set(key,{coreGraph:{active:[...coreDemo.active],selected:coreDemo.selected,search:coreDemo.search,offset:coreDemo.offset,center:coreDemo.center,selectedCluster:coreDemo.selectedCluster,camera:coreDemo.camera},view,selected,expanded:[...expanded],chartMode,chartDifficulty,chartSelection:[...chartSelection],
...
async function navigationHome(){
 ...
 try{
  ...
  coreDemo.active.clear();coreDemo.selected=null;coreDemo.search='';coreDemo.offset=0;coreDemo.center=null;coreDemo.selectedCluster=null;coreDemo.camera={zoom:1,x:0,y:0};hostNavigation.panel=null;hostNavigation.base=null;hostNavigation.positions.clear();expanded.clear();chartSelection.clear();grantDraft=null;
