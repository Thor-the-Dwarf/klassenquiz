...
function drawPracticeSidebar(){
 ...
 html+='<details open><summary>PVAP1</summary>';if(!topics.length){side.innerHTML=html+['BWL','IT','Mathematik','Software'].map(folder=>`<details><summary>${folder}</summary><p class="muted">Noch keine Übungen freigegeben.</p></details>`).join('')+'</details>';return}
