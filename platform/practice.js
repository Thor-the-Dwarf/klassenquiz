'use strict';
const P={mode:null,knowledge:false,knowledgeData:null,knowledgeRevision:0,courses:[],topics:[],selection:new Set(),difficulty:'easy',choosing:false,round:null,active:null};
